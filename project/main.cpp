...
int main()
{
	input_size(restaurant_num, district_num, cavalier_num, C, N, "fulltest1.txt");
	...
	input_array(restaurant, district, order, restaurant_num, district_num, cavalier_num, C, N, "fulltest1.txt");
